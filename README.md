...
For Minecraft **1.21.11 on Forge**, use the quick install steps in [SETUP.md](SETUP.md#forge-12111-quick-install) to download a current CI build and install it.
