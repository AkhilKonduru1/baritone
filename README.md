...
For Minecraft **1.21.11 on Forge**, download the latest CI artifacts directly here: [Latest 1.21.11 Forge build download](https://nightly.link/cabaletta/baritone/workflows/gradle_build.yml/master/artifacts.zip).
Extract `artifacts.zip`, then follow the quick install steps in [SETUP.md](SETUP.md#forge-12111-quick-install) to pick the `baritone-api-forge-*.jar` file and install it.
